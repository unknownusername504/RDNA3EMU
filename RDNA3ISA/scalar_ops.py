...
class ScalarOps:
    ...
    def s_add_u32(self, reg_d, reg_s0, reg_s1):
        reg_s0_value = self.registers.get_sgpr_u32(reg_s0)
        reg_s1_value = self.registers.get_sgpr_u32(reg_s1)
        reg_d_value = reg_s0_value + reg_s1_value
        reg_scc_value = 1 if (reg_d_value >= 2**32) else 0
        self.registers.set_scc_value(reg_scc_value)
    ...
    def s_sub_u32(self, reg_d, reg_s0, reg_s1):
        ...
        self.registers.set_scc_value(reg_scc_value)
        self.registers.get_sgpr_u32(reg_d, reg_d_value)
    ...
    def s_add_i32(self, reg_d, reg_s0, reg_s1):
        reg_s0_value = self.registers.get_sgpr_i32(reg_s0)
        reg_s1_value = self.registers.get_sgpr_i32(reg_s1)
        reg_d_value = reg_s0_value + reg_s1_value
    ...
    def s_addc_u32(self, reg_d, reg_s0, reg_s1):
        reg_s0_value = self.registers.get_sgpr_u32(reg_s0)
        reg_s1_value = self.registers.get_sgpr_u32(reg_s1)
        reg_scc_value = self.registers.get_scc_value()
    ...
    def s_lshl_b64(self, reg_d, reg_s0, reg_s1):
        reg_s0_value = self.registers.get_sgpr_u64(reg_s0)
        reg_s1_value = self.registers.get_sgpr_u64(reg_s1)
        reg_d_value = reg_s0_value << reg_s1_value
        reg_scc_value = 1 if (reg_d_value != 0) else 0
        self.registers.set_scc_value(reg_scc_value)
    ...
    def s_ashr_i64(self, reg_d, reg_s0, reg_s1):
        reg_s0_value = self.registers.get_sgpr_i64(reg_s0)
        reg_s1_value = self.registers.get_sgpr_u64(reg_s1)
        reg_d_value = reg_s0_value >> reg_s1_value
        reg_scc_value = 1 if (reg_d_value != 0) else 0
        self.registers.set_scc_value(reg_scc_value)
    ...
    def s_or_not1_b64(self, reg_d, reg_s0, reg_s1):
        reg_s0_value = self.registers.get_sgpr_i64(reg_s0)
        reg_s1_value = self.registers.get_sgpr_i64(reg_s1)
        reg_d_value = reg_s0_value | ~reg_s1_value
        reg_scc_value = 1 if (reg_d_value != -1) else 0
        self.registers.set_scc_value(reg_scc_value)
        self.registers.set_sgpr_u64(reg_d, reg_d_value)
    ...
    def s_pack_ll_b32_b16(self, reg_d, reg_s0, reg_s1):
        reg_s0_value = self.registers.get_sgpr_u16(reg_s0)
        reg_s1_value = self.registers.get_sgpr_u16(reg_s1)
    ...
    def c_move_b32(self, reg_d, reg_s0):
       if (self.registers.get_scc_value() == 1):
